...
export const PAISAJES_LOADING = 'PAISAJES_LOADING';
export const ADD_PAISAJES = 'ADD_PAISAJES';
export const PAISAJES_FAILED = 'PAISAJES_FAILED';

export const ADD_PAISAJE = 'ADD_PAISAJE';
export const POST_PAISAJE = 'POST_PAISAJE';
export const DELETE_PAISAJE = 'DELETE_PAISAJE';
